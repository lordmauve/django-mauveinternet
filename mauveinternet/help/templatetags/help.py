...
class InlineHelpNode(Node):
	...
	def get_help(self, slug):
		...
		return mark_safe(' <a class="inlinehelp" href="%s" target="inlinehelp" title="Help on this item"><img src="/assets/images/help_icon.png" alt="Help on this item" /></a>' % reverse('quick-help', kwargs={'slug': self.slug}))
